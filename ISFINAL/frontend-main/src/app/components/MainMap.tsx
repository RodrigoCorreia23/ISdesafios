...
const LeafleatMap = ({
    ...
    updatePoint: (id: number, latitude: number, longitude: number) => Promise<{ status: boolean }>;
}) => {
        ...
        const geoJSONPlaces = warehouses.map((place) => {
            const geoJSONPlace: any = {
                ...
                properties: {
                    id: place.id,
                    region: place.region,
                    product_line: place.product_line,
    ...
    // Centralizar no ponto relacionado ao ID inserido
    useEffect(() => {
    if (searchId) {
        const warehouse = warehouses.find(
            (wh: Warehouse) => String(wh.id) === String(searchId)
        );
                        ...
                        {clusters.map((cluster: any) => {
                            ...
                            return (
                                ...
                                >
                                    <Popup>
                                        <div>
                                            <p>Warehouse ID: {cluster.properties.id}</p>
                                            <p>Region: {cluster.properties.region}</p>
                                            <p>Product Line: {cluster.properties.product_line}</p>
